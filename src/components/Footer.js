            ...
            <div className={styles.footerContent}>
                <div className={styles.contactHolder}>
                    ...
                    <ul className={styles.contactList}>
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/mattkarwan/" target="__blank">
                            ...
                            <a href="https://github.com/mattkarwan" target="__blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <title>GitHub</title>
                ...
                <div className={styles.navigation}>
                    ...
                    <ul className={styles.navigationGrid}>
                        ...
                        <li onClick={() => scrollTo('workPage')}>My Work</li>
                        <li onClick={() => scrollTo('aboutPage')}>About Me</li>
                        <li onClick={() => scrollTo('testimonialsPage')}>Testimonials</li>
                        <li onClick={() => scrollTo('contactPage')}>Contact</li>
                    </ul>
                </div>

                <div className={styles.copyright}>&copy; Matt Karwan 2021</div>
